...
/***/ "./src/block-contrast-analyzer/index.js":
/*!**********************************************!*\
  !*** ./src/block-contrast-analyzer/index.js ***!
  \**********************************************/
/*! no exports provided */
...
/* harmony import */ var _swatch_contrast__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./swatch-contrast */ "./src/block-contrast-analyzer/swatch-contrast.js");
...
var themeColors = select('core/editor').getEditorSettings().colors; // Assign an empty array.

var colorPairs = []; // Loop through theme color palette.

for (var i = 0; i < themeColors.length - 1; i++) {
...
registerBlockType('tca/swatch', {
  ...
  edit: function edit(_ref) {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("ul", {
      ...
      var results = colorPairs.filter(function (pair) {
        return pair.slug !== value.slug;
      });
      return (// Outputs a list of each theme color.
        ...
        }, value.name), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("ul", {
          className: 'color-pairs'
        }, results.map(function (pair, key) {
          return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("li", {
            key: key
          }, pair.name, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_swatch_contrast__WEBPACK_IMPORTED_MODULE_1__["default"], {
            fontSize: 18,
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("ul", {
      ...
      return (// Outputs a list of each theme color.
        Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("li", {
          ...
          className: 'primary-color-label'
        }, 'Foreground: ' + value.name), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("ul", {
          className: 'color-pairs'
        }, results.map(function (pair, key) {
          return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("li", {
            key: key
          }, 'Background: ' + pair.name, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_swatch_contrast__WEBPACK_IMPORTED_MODULE_1__["default"], {
            fontSize: 18,
            swatchColorName: pair.name,
            swatchPrimaryColor: value.color,
            swatchSecondaryColor: pair.color
...
/***/ "./src/block-contrast-analyzer/swatch-contrast.js":
/*!********************************************************!*\
  !*** ./src/block-contrast-analyzer/swatch-contrast.js ***!
  \********************************************************/
...
/* harmony import */ var tinycolor2_tinycolor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tinycolor2/tinycolor */ "./node_modules/tinycolor2/tinycolor.js");
/* harmony import */ var tinycolor2_tinycolor__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(tinycolor2_tinycolor__WEBPACK_IMPORTED_MODULE_2__);
...
function checkContrastRating(contrastValue) {
  ...
  var contrastRating = ''; // Assign a rating based on the values.
...
function ThemeColorComparison(_ref) {
  var swatchColorName = _ref.swatchColorName,
      swatchPrimaryColor = _ref.swatchPrimaryColor,
      swatchSecondaryColor = _ref.swatchSecondaryColor,
      tinyBackgroundColor = _ref.tinyBackgroundColor,
      tinyTextColor = _ref.tinyTextColor;
  var swatchTitle = swatchColorName;
  var textAnalyzeColor = swatchPrimaryColor;
...
function ThemeSwatchAnalyze(_ref2) {
  var swatchColorName = _ref2.swatchColorName,
      swatchPrimaryColor = _ref2.swatchPrimaryColor,
      swatchSecondaryColor = _ref2.swatchSecondaryColor,
  ...
  var tinyBackgroundColor = tinycolor2_tinycolor__WEBPACK_IMPORTED_MODULE_2___default()(swatchSecondaryColor);
  var tinyTextColor = tinycolor2_tinycolor__WEBPACK_IMPORTED_MODULE_2___default()(swatchPrimaryColor);
  var hasTransparency = tinyBackgroundColor.getAlpha() !== 1 || tinyTextColor.getAlpha() !== 1;
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(ThemeColorComparison, {
    fontSize: fontSize,
...
/* harmony default export */ __webpack_exports__["default"] = (ThemeSwatchAnalyze);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _block_contrast_analyzer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./block-contrast-analyzer */ "./src/block-contrast-analyzer/index.js");
